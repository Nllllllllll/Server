...
namespace PersistenceServer
{
    ...
    {        
        ...
        // À utiliser quand le joueur n'est pas en ligne, mais que l'info du groupe doit être renvoyée
        ...
        // Lors de la suppression par id, le personnage peut être hors ligne, donc on peut ne pas avoir de référence Player valide
        ...
        {
            Console.WriteLine($"Groupe dissous: {Id}");

            // envoyer le message aux membres du groupe d'abord, pendant qu'ils sont encore valides
            // et ensuite retirer leur PartyRef
            ...
            // récupérer les connexions serveur d'abord, avant de vider les memberids
        ...
        /* Envoie un message "un joueur a rejoint votre groupe" aux clients */
        ...
        /* Envoie un message "un joueur a quitté votre groupe" aux clients */
        ...
        /* Chaque fois qu'une info de groupe est mise à jour, on l'envoie à tous les serveurs de jeu avec ces joueurs en ligne
        * On fait confiance aux serveurs de jeu pour faire un diff entre l'ancienne info de groupe et la nouvelle pour déterminer qui est parti, etc...
        * Les serveurs de jeu mettront à jour l'info sur PlayerController, et elle sera répliquée aux clients de jeu */
        ...
        /* Récupère toutes les connexions client des membres du groupe
        Plus toutes les connexions serveur où les membres du groupe jouent */
        ...
        /* Récupère toutes les connexions serveur où les membres du groupe sont en ligne */
