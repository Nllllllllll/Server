...
namespace PersistenceServer
{
    ...
    public class SettingsReader
    {
        ...
        public readonly string ServerPassword; // mot de passe avec lequel les serveurs de jeu peuvent se connecter
        public readonly string UniversalCookie; // cookie utilisé par les clients se connectant depuis PIE, qui par conséquent n'ont pas de cookie valide, mais ont quand même besoin d'un personnage
